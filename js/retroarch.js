...
var EmulatorJS = (function () {
    ...
    return (
      function (EmulatorJS) {
        ...
        var STACK_BASE = 1122144,
          DYNAMIC_BASE = 6365024,
          DYNAMICTOP_PTR = 1122112;
        ...
        function _emscripten_set_main_loop(func, fps, simulateInfiniteLoop, arg, noSetTiming) {
          ...
          Browser.mainLoop.runner = function Browser_mainLoop_runner() {
            ...
            if (Browser.mainLoop.queue.length > 0) {
              ...
              console.log('主循环阻塞器 "' + blocker.name + '" took ' + (Date.now() - start) + " ms");
            ...
            if (Browser.mainLoop.method === "timeout" && Module.ctx) {
              console.warn('看起来您在主循环中没有使用 requestAnimationFrame 进行渲染. 为了使用 requestAnimationFrame,您应该在 emscripten_set_main_loop 中使用 0 作为帧速率,因为这可以大大提高您的帧速率!');
        ...
        var Browser = {
          ...
          updateCanvasDimensions: function (canvas, wNative, hNative) {
            if (1) return console.log(canvas);
            if (wNative && hNative) {
        ...
        function _emscripten_set_canvas_element_size(target, width, height) {
          if (!Module["canvas"]) return -4;
            ...
            console.log(`屏蔽屏幕设置:${width},${height}`);
            Module["canvas"].width = Module.CanvasWidth;
            Module["canvas"].height = Module.CanvasHeight;
          }
          return 0;
        }
        ...
        Module["pauseMainLoop"] = function Module_pauseMainLoop() {
          Module.onRunning = false;
          Browser.mainLoop.pause()
        };
        Module["resumeMainLoop"] = function Module_resumeMainLoop() {
          if(Module.runMusic&&RA.startTime==0) return Module.MusicMSG();
          Module.onRunning = true;
        ...
        var _event_load_save_files = Module["_event_load_save_files"] = function () {
          return Module["asm"]["_event_load_save_files"].apply(null, arguments)
        };
        ...
        function abort(what) {
          ...
          ABORT = true;
          EXITSTATUS = 1;
          console.warn("abort(" + what + "). Build with -s ASSERTIONS=1 for more info.");
